	...
	Union = window.Union || {}, Array.prototype.indexOf = function(n) {
		...
		checkIp: function(o) {
			/*$.ajax({
				...
				dataType: "jsonp",
				success: function(n) {*/
					 /*(o ? ($("#union .rrname,#union .rrnum").show(), Union.logFn.gVaildIdcard = 1, $(".davied").hide()) : ($("#union .rrname,#union .rrnum").hide(), Union.logFn.gVaildIdcard = 0, $(".davied").show()))*/
					 $("#union .rrname,#union .rrnum").show(), Union.logFn.gVaildIdcard = 1, $(".davied").hide()
				/*}
			})*/
		},
		toggleUi: function(n) {
