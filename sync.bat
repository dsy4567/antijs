cmd.exe /c curl https://www.4399.com/antijs/Antiindulgence.js -o Antiindulgence.js
cmd.exe /c curl http://n.7k7kimg.cn/uploads/cdn/api/loginPlus/css/logFn.min.css -o logFn.min.css
...
cmd.exe /c curl http://h5.7k7k.com/js/anti/Anti.js -o Anti.js
cmd.exe /c curl http://www.7k7kjs.cn/static/qike/play/js/play-fcm/login-v3.js -o login-v3.js